...
{
    [Authorize]
    public class GettingCustomerInfoModel : PageModel
    {
            ...
            public GettingCustomerInfoModel(IProductQuery productQuery, ICartCalculateService calculateService, ICartService cartService, IOrderApplication orderApplication, IZarinPalFactory zarinpal, IAuthHelper authHelper)
            {
            ...
            public void OnGet(double payAmount, int sendMethod)
            {
                ...
                Cart.PayAmount = payAmount;
                Cart.SendMethod = sendMethod;
        ...
        public IActionResult OnPostPay(int paymentMethod)
            {
                ...
                return RedirectToPage("/PaymentResult",
                    paymentResult.Succeeded(
                        "سفارش شما با موفقیت ثبت شد. پس از تماس کارشناسان ما و پرداخت وجه، سفارش ارسال خواهد شد.", null, cart.PayAmount,cart.SendMethod));
            }
                ...
                [FromQuery] long oId)
            {
                ...
                if (status == "OK" && verificationResponse.Status >= 100)
                {
                    ...
                    result = result.Succeeded("پرداخت با موفقیت انجام شد.", issueTrackingNo, Cart.PayAmount,Cart.SendMethod);
